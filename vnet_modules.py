...
class vnetConv1d(nn.Conv1d):
    ...
    def __init__(self,
        ...
        super(vnetConv1d, self).__init__(
...
class vnetConv2d(nn.Conv2d):
    ...
    def __init__(self,
        ...
        super(vnetConv2d, self).__init__(
            in_channels, out_channels, kernel_size, stride, padding=padding, dilation=dilation,
            groups=1, bias=bias, padding_mode=padding_mode, device=device, dtype=dtype)
...
class vnetEmbedding(nn.Embedding):

    def __init__(self, num_embeddings, embedding_dim,
                 scale_grad_by_freq=False,
                 sparse=False, _weight=None,
                 device=None, dtype=None):
        super(vnetEmbedding, self).__init__(
